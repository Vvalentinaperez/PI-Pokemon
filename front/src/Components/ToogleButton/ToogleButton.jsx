...
import '../ToogleButton/ToogleButton.css';
    ...
    return (
        <button title="Toggle Menu" className="toggle-btn" onClick={onClick}>
            <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24">
                ...
                {/* Si la SideBar está abierta, solo mostramos la línea horizontal */}
                <path d="M8 12H16" strokeWidth="1.5"></path>
                {/* Si la SideBar está cerrada, mostramos la línea vertical */}
